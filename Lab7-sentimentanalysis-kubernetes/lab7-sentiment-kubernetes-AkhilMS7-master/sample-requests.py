...
#
REST = os.getenv("REST") or "34.96.116.155:80"
print(REST)
...
def mkReq(reqmethod, endpoint, data):
    ...
    if not data:
        response = reqmethod(f"http://{REST}/{endpoint}",
...
#mkReq(requests.get, "apiv1/cache/sentiment")

mkReq(requests.post, "apiv1/sentence",
      data={
          "model": "sentiment",
          "sentences": [
                    "I think this is a good thing",
